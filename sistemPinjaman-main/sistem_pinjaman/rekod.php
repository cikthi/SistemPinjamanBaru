...
// 	$tarikh = $_POST['tarikh'];
//     $padam = $_POST['padam'];
//     $sql = "UPDATE pendaftaran SET idguru='$idguru', idperalatan='$idperalatan',idguru='$idguru', 
...
//     $idguru = $rekod['idguru'];
//     $idperalatan = $rekod['idperalatan'];
//     $kegunaan = $rekod['kegunaan'];
//     $tarikh = $rekod['tarikh'];
//     $padam = $_POST['padam'];
// }
//padam rekod
// $idguru = $_GET['idguru'];
// $sql = "DELETE FROM rekod WHERE idguru= '$idguru'";
// $result = mysqli_query($conn, $sql);
// if ($result)
...
<body>
 <?php
        ...
        $sql = "SELECT * FROM rekod ORDER BY idguru";
    ...
    <fieldset>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="peralatan.php?idperalatan=<?php echo $rekod['idperalatan'];?>">
                    <img src=img/update.png> </a> <a href="rekod.php?idperalatan=<?php echo $rekod['idperalatan'];?>">
